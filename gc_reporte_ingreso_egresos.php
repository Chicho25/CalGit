        ...
        <div class="col-lg-12">
            ...
            <div class="block">
                <div class="block-header">
                    ...
                    <h3 class="block-title">Reporte de Ingresos & eGresos</h3>
                </div>
                <div class="block-content block-content-narrow">
                    <!-- jQuery Validation (.js-validation-bootstrap class is initialized in js/pages/base_forms_validation.js) -->
                    <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
                    <form class="form-horizontal" action="reportes/gc_reporte_ingreso_egresos.php" method="post" target="_blank">

                        <div class="form-group">
                            <label class="col-md-2 control-label">Fecha</label>
                            <div class="col-md-9">
                              <div class="input-group input-daterange gcreacion">
                                  <input type="text" class="js-datepicker form-control fechas1" autocomplete="off" name="fecha_a_ini" placeholder="Desde">
                                  <div style="min-width: 0px" class="input-group-addon"></div>
                                  <input type="text" class="js-datepicker form-control fechas1" autocomplete="off" name="fecha_a_fin" placeholder="Hasta">
                              </div>
                            </div>
                        </div>
                        <div class="form-group">
