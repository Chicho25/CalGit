...
<?php 	function obtenert_id_cuenta_cheque($conexion, $id_chequera){
	...
	<?php 	function estado_cuenta_bancario($conexion, $id_cuenta, $desde, $hasta){
					...
					$sql = "select mbo.id_movimiento_bancario,
								   ...
								   mc.cl_apellido,
								   mbo.mb_monto,
								   IF(mbo.id_tipo_movimiento in (2,3,5,7,14,17,19,20,21,22,23,13,16,24) ,
    							   ...
    							   (select sum(IF(mb.id_tipo_movimiento in (2,3,5,7,14,17,19,20,21,22,23,13,16,24) , mb.mb_monto ,  -mb.mb_monto ))
